...
const Home = () => {
    return (
        <>
            <Helmet>
                <title>Brilliant Driving Academy - Auckland</title>
                <meta name="description" content="Brilliant Driving Academy provides professional Driving Lessons at all experience levels, whether you're a novice driver or someone preparing for their full licence test" />
